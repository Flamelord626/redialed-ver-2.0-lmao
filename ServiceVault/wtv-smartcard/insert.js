...
var scp;
if (wasBase64) {
    let buff = Buffer.from(scpb, "base64");
    scp = buff.toString("ascii");
} else {
    scp = scpb;
}
...
if (request_headers.query.error) {
    ...
    switch (error) {
        case "-68":
            errorMsg = "WebTV can't use the smart card. Make sure it is inserted with the gold metallic contacts facing downwards.";
            break; // Added break to prevent fall-through
        default:
            errorMsg = "WebTV can't recognize this smart card. It might be defective or of the wrong type.";
    }
            ...
            <tr>
                <td absheight=5 colspan=3>
                    <table cellspacing=0 cellpadding=0>
                        <tr>
                            <td abswidth=104 absheight=2 valign=middle align=center bgcolor="21372a">
                                <img src="wtv-home:/ROMCache/Spacer.gif" width=1 height=1>
                        <tr>
                            <td abswidth=104 absheight=1 valign=top align=left>
                        <tr>
                            <td abswidth=104 absheight=2 valign=top align=left bgcolor="53896a">
                                <img src="wtv-home:/ROMCache/Spacer.gif" width=1 height=1>
                    </table>
                <tr>
                    <td absheight=25 colspan=3>
                    <table cellspacing=0 cellpadding=0>
                        <tr><td height=2>
                        <tr><td abswidth=5>
                        <td abswidth=93>
                ...
                <tr>
                    ...
                    <table cellspacing=0 cellpadding=0>
                        <tr>
                            <td abswidth=104 absheight=2 valign=middle align=center bgcolor="355844">
                                <img src="wtv-home:/ROMCache/Spacer.gif" width=1 height=1>
                        <tr>
                            <td abswidth=104 absheight=1 valign=top align=left>
                        <tr>
                            <td abswidth=104 absheight=2 valign=top align=left bgcolor="355844">
                                <img src="wtv-home:/ROMCache/Spacer.gif" width=1 height=1>
                    </table>
                <tr><td absheight=20>
                <tr>
                    <td absheight=244 align=right valign=bottom colspan=3>
...
Content-Type: text/html\n`;
        ...
        case "O":
            data = `<HTML>
<HEAD>
<TITLE>Smart Card OISP funny</TITLE>
<DISPLAY nosave nosend>
</HEAD>
<print blackandwhite>
<sidebar width=110> 
    ...
    <BODY BGCOLOR="#191919" TEXT="#44cc55" LINK="189CD6" VLINK="189CD6" HSPACE=0 VSPACE=0 FONTSIZE="large">
        <table cellspacing=0 cellpadding=0>
            ...
            <td valign=top align=left>
            <tr><td><td valign=top align=left absheight=210>
                WebTV can't use the OISP smart card.
            <td>
            <tr><td absheight=20>
            <tr><td>
            <td colspan=2 absheight=2 bgcolor="2B2B2B">
